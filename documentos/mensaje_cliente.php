...
-->
  ...
  <tr>
    <th>Link Referencial</th>
    <th>Imagenes de Entrega</th> 
  </tr>
...
$path_file=$row["path_file"];
	...
	<tr>
		<td>
			<center><a href="<?php echo 'other_files/'.$path_file; ?>"><?php echo $path_file; ?></a></center>		</td>		
		<td>
			<center><img border="0" src="<?php echo 'other_files/'.$path_file; ?>" width="150" height="150"></center>
		</td>
	</tr>
